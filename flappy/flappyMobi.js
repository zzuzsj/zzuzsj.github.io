    ...
    Flappy.prototype = {
        bindStage: function () {
            ...
            container.on('touchstart', function (e) {
                ...
                var text = that._layer.getIntersection({
                    x:tx,
                    y:ty
                }, 'Text');
                if (!text) {
        ...
        gameStart: function () {
            ...
            var step = function () {
                that._useTime++;
                if (that._useTime == that._pipeTime) {
                    that._useTime=0;
                    that.createPipe();
                };
                that.pipeMove();
        ...
        createPipe: function () {
            var total = this._stageH - this._pipeSpace;
            var upH = Math.floor(Math.random() * (this._stageH - this._pipeSpace-50)) + 20;
            var lowH = total - upH;
            var that = this;
